...
<div class="container">
<div class="card mt-3">
<div class="card-header"><strong>Step 3: Spouses Info</strong></div>
<div class="card-body">
<form action="{{ route('idps.create.step.three.post') }}" method="POST">
@csrf
@if ($errors->any())
...
<td><input type="text" name="moreFields[0][spouse_name]" placeholder="Full Name" class="form-control" /></td>
...
<label for="male">M</label><br><input type='radio'  value="female"  id="female" name="moreFields[0][gender]"/><label for="female">F</label></td>
                                ...
                                <label for="graduate">SSCE</label><br>
                                 ...
                                 <td><input type="text" name="moreFields[0][telly]"  class="form-control" /></td>           
...
<div class="card-footer">
                        <div class="row">
                            <div class="col-md-6 text-left">
                                <a href="{{ route('idps.create.step.two') }}" class="btn btn-danger pull-right">Previous</a>
                            </div>
